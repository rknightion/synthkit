...
# Regenerate the cross-harness skill symlink farm (.claude/skills, .agents/skills)
# from the canonical source under plugins/synthkit/skills/. AGENTS.md is canonical
# repository guidance and is never generated by this target.
skills-sync:
