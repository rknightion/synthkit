...
func Catalog() *core.Registry {
	...
	reg.RegisterConstruct(withMetricProducers(ec2.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(cwinfra.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(rds.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(host.Registration(), producerPromRW, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(elasticache.Registration(), producerUnlabelled, producerOTLPNative))
	...
	reg.RegisterConstruct(withMetricProducers(docdb.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(neptune.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(aoss.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(mwaa.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(glue.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(bedrock.Registration(), producerUnlabelled, producerOTLPNative))
	reg.RegisterConstruct(withMetricProducers(agentcore.Registration(), producerUnlabelled, producerOTLPNative))
	...
	reg.RegisterConstruct(withMetricProducers(envoygateway.Registration(), producerPromRW, producerOTLPNative))
