...
//
// Vendored from github.com/grafana/pyroscope api/google/v1/profile.proto.
// Transformation: set option go_package to synthkit path.
// Field numbers and wire contract are identical to upstream.
...
type Location struct {
	...
	// Provides an indication that multiple symbols map to this location's address.
...
const file_profile_proto_rawDesc = "" +
	"\n" +
	"\rprofile.proto\x12\tgoogle.v1\"\xbf\x04\n" +
	"\aProfile\x125\n" +
	...
	"\n" +
	"start_line\x18\x05 \x01(\x03R\tstartLineBZ\n" +
	"\x1dcom.google.perftools.profilesB\fProfileProtoZ+synthkit/internal/pyroscope/pprofpb;pprofpbb\x06proto3"
