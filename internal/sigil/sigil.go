...
// content-capture modes, token-type values, the agento11y_eval_* metric names + advisory buckets,
...
// The aiagent workload builds gen_ai/sigil spans + gen_ai_client_*/agento11y_eval_* metrics + the
