...
const file_types_proto_rawDesc = "" +
	"\n" +
	"\vtypes.proto\x12\x16io.prometheus.write.v2\"m\n" +
	"\aRequest\x12\x18\n" +
	"\asymbols\x18\x04 \x03(\tR\asymbols\x12B\n" +
	"\n" +
	"timeseries\x18\x05 \x03(\v2\".io.prometheus.write.v2.TimeSeriesR\n" +
	"timeseriesJ\x04\b\x01\x10\x04\"\xae\x02\n" +
	"\n" +
	"TimeSeries\x12\x1f\n" +
	"\vlabels_refs\x18\x01 \x03(\rR\n" +
	"labelsRefs\x128\n" +
	"\asamples\x18\x02 \x03(\v2\x1e.io.prometheus.write.v2.SampleR\asamples\x12A\n" +
	"\n" +
	"histograms\x18\x03 \x03(\v2!.io.prometheus.write.v2.HistogramR\n" +
	"histograms\x12>\n" +
	"\texemplars\x18\x04 \x03(\v2 .io.prometheus.write.v2.ExemplarR\texemplars\x12<\n" +
	"\bmetadata\x18\x05 \x01(\v2 .io.prometheus.write.v2.MetadataR\bmetadataJ\x04\b\x06\x10\a\"_\n" +
	"\bExemplar\x12\x1f\n" +
	"\vlabels_refs\x18\x01 \x03(\rR\n" +
	"labelsRefs\x12\x14\n" +
	...
	"\x14METRIC_TYPE_STATESET\x10\a\"\xe1\x06\n" +
	"\tHistogram\x12\x1d\n" +
	...
	"\x10zero_count_float\x18\a \x01(\x01H\x01R\x0ezeroCountFloat\x12I\n" +
	"\x0enegative_spans\x18\b \x03(\v2\".io.prometheus.write.v2.BucketSpanR\rnegativeSpans\x12'\n" +
	"\x0fnegative_deltas\x18\t \x03(\x12R\x0enegativeDeltas\x12'\n" +
	"\x0fnegative_counts\x18\n" +
	" \x03(\x01R\x0enegativeCounts\x12I\n" +
	"\x0epositive_spans\x18\v \x03(\v2\".io.prometheus.write.v2.BucketSpanR\rpositiveSpans\x12'\n" +
	...
	"\x06length\x18\x02 \x01(\rR\x06lengthB/Z-synthkit/internal/sink/promrw/writev2;writev2b\x06proto3"
