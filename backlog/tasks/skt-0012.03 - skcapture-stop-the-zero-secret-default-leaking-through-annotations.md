...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Annotations are filtered rather than copied wholesale
- [ ] #2 kubectl.kubernetes.io/last-applied-configuration never reaches a capture
- [ ] #3 The filter is an allowlist of keys the mapper consumes, not a denylist of known-bad names
- [ ] #4 A test proves a capture of an object carrying a spec-embedding annotation excludes it
- [ ] #5 The zero-secret claim in docs/tools.md states what it does and does not cover
<!-- AC:END -->
