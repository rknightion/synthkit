...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 An AKS environment stands up and tears down from terraform in the frozen module shape
- [x] #2 k8s-monitoring runs against it with the same configuration as the EKS and k3d captures
- [x] #3 A capture lands in the reality corpus tagged substrate aks, with provenance
- [x] #4 Where AKS diverges from EKS is recorded as findings, not silently reconciled in this task
<!-- AC:END -->
