...
Recovery RC gate complete: v1.3.1-rc.1 at bddbc657 passed publisher run 32488593292, including exact index/signature/provenance/version identity and published Compose health, writable state, fake-sink delivery, teardown, and ownership restoration. Independent verify-image passed for index sha256:6af062e7ae7dafe902852611e31fcd1a46658ee442d0eb28ee7c65f358b4e52e. Jules then upgraded from the legacy deployment by CAS-changing only SYNTHKIT_IMAGE_REF; exact runtime identity, 1.3.1-rc.1 revision, health/readiness, writable state, four configured sinks with zero failures, exactly nine optional-lane dispositions, and post-start metrics/logs/traces landing all passed. Retained legacy and RC snapshots plus the RC closed identity record remain outside the checkout. Release PR #99 was merged only after this standing-host proof; stable 1.3.1 publication is now the next gate.
<!-- SECTION:NOTES:END -->
