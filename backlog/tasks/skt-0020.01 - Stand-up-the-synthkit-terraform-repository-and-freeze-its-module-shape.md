...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 The repository exists with visibility Rob explicitly chose
- [x] #2 A per-provider module layout, remote state and a documented apply/destroy path are established
- [x] #3 The module interface every provider implements is frozen before the second provider is written
- [x] #4 An orphaned environment is detectable rather than silent
<!-- AC:END -->

## Definition of Done
<!-- DOD:BEGIN -->
- [x] #1 terraform validate and fmt -check pass for every module
- [x] #2 A full apply then destroy cycle completes for at least one environment, verified post-destroy
<!-- DOD:END -->
