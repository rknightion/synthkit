...
- [x] #3 Drift detection is not implementable until a shipping series carries the observed chart version; SK-107 records the gap; the k3d lab remains on captured current version 4.5.0
<!-- AC:END -->
