...
2026-09-06 final reconciliation: docs/reality-corpus.md now states the 27,212-line human-readability budget, and signal-fidelity prints the measured line count against it without turning a size-only breach into a false gate failure. The current full report measures 28,022 lines, above the bound, so AC8 remains unchecked. The kubelet runtime operation label repair is captured in Done subtask SKT-0010.20.
<!-- SECTION:NOTES:END -->
