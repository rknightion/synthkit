...
5. Run focused queue/pushstatus/selfobs/control/UI tests, review the integrated diff, run CodeRabbit, make gate and the explicit complete-catalog dry-run inventory, then live-failure/recovery proof on standing host before finalization.
...
10. Run focused Go/UI checks, CodeRabbit, make gate, complete-catalog dry-run inventory, then isolated standing host fake-sink loss/recovery proof with standing-deployment hash checks before finalization.
<!-- SECTION:PLAN:END -->
