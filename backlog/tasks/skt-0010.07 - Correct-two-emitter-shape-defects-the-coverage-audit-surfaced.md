...
- [x] #3 coredns_hosts_reload_timestamp_seconds is no longer emitted, consistent with modelling a Corefile that does not load the hosts plugin
- [x] #4 signals/k8s.md and signals/k8s-addons.md record both corrections with provenance
<!-- AC:END -->
