...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Karpenter-provisioned nodes group by their real NodePool, read from karpenter.sh/nodepool
- [x] #2 EKS managed nodegroups continue to group by eks.amazonaws.com/nodegroup
- [x] #3 The provisioner recorded for a group reflects how those nodes are actually provisioned
- [x] #4 A cluster mixing Karpenter and managed nodegroups produces both kinds correctly in one capture
- [x] #5 Verified against the lab cluster: captured groups match the real NodePools and managed nodegroup, by name and node count
<!-- AC:END -->
