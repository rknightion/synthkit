...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 A decision is recorded on which shape belongs to which transport, with evidence rather than tidiness
- [x] #2 The addon lanes and signals/k8s.md agree on the shape for a given transport
- [x] #3 The decision is made before a podLogsViaLoki permutation is captured, not settled by that capture landing on one of them
- [x] #4 The comparator joins each shape to the transport it actually belongs to
<!-- AC:END -->
