...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 An ArgoCD application deploys the chart to the lab cluster and syncs healthy
- [x] #2 It emits to the emission-test stack, not the stack the reality corpus reads
- [x] #3 Credentials reach it without any credential value entering the infrastructure repo
- [x] #4 Upgrade and rollback are exercised at least once through ArgoCD
- [x] #5 No exclusion is added to the lab monitoring config, per the recorded contamination finding
<!-- AC:END -->
