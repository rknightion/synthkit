...
- [x] #3 deploy/skcapture/job.yaml and docs/tools.md reference the release form, with the edge form documented as the development override
<!-- AC:END -->
