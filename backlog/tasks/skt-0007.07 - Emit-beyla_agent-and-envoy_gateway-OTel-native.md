...
- [x] #2 Each blueprint switch models the real product config discriminator
- [x] #3 No OTLP name is derived by un-mangling a Prometheus name without capture evidence
- [x] #4 signals/otlp-metrics.md covers every added family with provenance and date
<!-- AC:END -->
