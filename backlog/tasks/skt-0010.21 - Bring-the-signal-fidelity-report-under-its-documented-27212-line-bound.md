...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 The report produced by just signal-fidelity measures at or under 27,212 lines, pasted, on main
- [x] #2 No finding, PENDING stub, contradiction or exemption disappears: the set of (class, signal, field, substrate, source) tuples before and after is identical, pinned by a test on the renderer
- [x] #3 The size measurement and bound in docs/reality-corpus.md are unchanged, and the parent SKT-0010 AC8 is checked with the pasted count
- [x] #4 The machine-readable report and the CI gate semantics are byte-for-byte or behaviourally unchanged, stated with evidence
<!-- AC:END -->
