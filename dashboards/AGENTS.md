...
view — the self-serve dashboard (`cmd/synthkit-control-dash`), powered by the Infinity datasource
against the control plane's `/control/*` routes rather than promrw. It exposes only the
