...
//   go.opentelemetry.io/proto/otlp        — trace ResourceSpans proto types (NOT the metrics/trace SDK)
//   google.golang.org/protobuf            — proto marshal
//   github.com/joho/godotenv              — optional .env loader
//   gopkg.in/yaml.v3                       — YAML blueprint/config decoding
...
require (
	...
	github.com/grafana/nanogit v1.5.0
